    ...
    <div className="details-main">
      ...
      <div className="details-container-info">
        ...
        <div style={{ display: "flex", alignItems: "center"}}>
          <button onClick={down} className="details-button-select">-</button>
          <p style={{paddingLeft: "10px", paddingRight: "10px", fontSize: "20px"}}>{shop}</p> <button onClick={up} className="details-button-select">+</button>
        </div>
